...
#ifndef AUROPAY_SWIFT_H
#define AUROPAY_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="AuroPay",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

#if defined(__OBJC__)

SWIFT_PROTOCOL("_TtP7AuroPay28AuroPayPaymentResultProtocol_")
...
/// Protocols
SWIFT_PROTOCOL("_TtP7AuroPay27APPaymentCompletionProtocol_")
...
SWIFT_PROTOCOL("_TtP7AuroPay35APPaymentCompletionProtocolWithData_")
...
SWIFT_CLASS("_TtC7AuroPay7APTheme")
...
SWIFT_CLASS("_TtC7AuroPay14AuroPayBuilder")
...
SWIFT_CLASS("_TtC7AuroPay7Auropay")
...
/// Customer Profile
SWIFT_CLASS("_TtC7AuroPay15CustomerProfile")
...
SWIFT_CLASS("_TtC7AuroPay17PaymentResultData")
